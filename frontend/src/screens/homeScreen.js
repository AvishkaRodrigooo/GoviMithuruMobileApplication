  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <Text style={styles.sectionSubtitle}>
        Tap to explore AI-powered tools
      </Text>
      ...
      >
        ...
        <View style={styles.cardText}>
          ...
          <Text style={styles.cardDesc}>
            Identify pest attacks using images
          </Text>
        </View>
      </Pressable>
      ...
      >
        ...
        <View style={styles.cardText}>
          ...
          <Text style={styles.cardDesc}>
            Yield and storage recommendations
          </Text>
        </View>
      </Pressable>
      ...
      >
        ...
        <View style={styles.cardText}>
          ...
          <Text style={styles.cardDesc}>
            Detect and classify weeds in fields
          </Text>
        </View>
      </Pressable>
