    ...
    <View style={styles.mainWrapper}>
      ...
      >
        ...
        <View style={styles.featuresGrid}>
          <Pressable style={[styles.featureCard, styles.featureLarge]} onPress={() => navTo('PestHome', 'pestHome')}>
            <View style={[styles.featureIcon, { backgroundColor: '#fef3c7' }]}>
              <MaterialCommunityIcons name="bug" size={40} color="#f59e0b" />
            </View>
            <Text style={styles.featureTitle}>Pest Forcasting system</Text>
            <Text style={styles.featureDesc}>Identify pest threads before they appear</Text>
          </Pressable>
      ...
      <View style={styles.bottomNav}>
        {['home', 'pest', 'harvest', 'weeds', 'pricing'].map((tab) => (
          <Pressable 
            ...
            onPress={() => navTo(tab === 'home' ? 'Home' : tab === 'pest' ? 'PestHome' : tab === 'harvest' ? 'Stage' : tab === 'weeds' ? 'weedsDashboard' : 'Pricing', tab)}
          >
