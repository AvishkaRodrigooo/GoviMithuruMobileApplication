...
export default function BroadLeavesKillersScreen() {
  ...
  if (loading) return <ActivityIndicator size="large" color="#8b5cf6" style={{ marginTop: 50 }} />;

  return (
    <View style={styles.container}>
      <Text style={styles.title}>🍃 Broadleaf / Sedges Killers</Text>
      <FlatList
        data={data}
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: 'bold', marginBottom: 12, color: '#7c3aed' },
  card: { 
