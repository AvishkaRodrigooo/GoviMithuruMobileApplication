...
// Suitability Score (based on primary confidence)
const suitabilityScore = recommendation?.primary?.confidence || 0;

// Rain Risk logic
let rainRisk = "Moderate";

if (recommendation?.weather?.rainfall > 200) {
  rainRisk = "High Rainfall Expected";
} else if (recommendation?.weather?.rainfall < 80) {
  rainRisk = "Low Rainfall Risk";
}

// Climate Suitable Variety
const climateVariety =
  recommendation?.primary?.variety || "Not Available";
...
Generated by AI Paddy Farming Assistant
        ...
        <View style={styles.section}>
          ...
          <View style={styles.weatherGrid}>
            ...
            <View style={styles.weatherItem}>
              <MaterialCommunityIcons name="thermometer" size={22}/>
            ...
            <View style={styles.weatherItem}>
              <MaterialCommunityIcons name="water-percent" size={22}/>
            ...
            <View style={styles.weatherItem}>
              <MaterialCommunityIcons name="weather-rainy" size={22}/>
            ...
            <View style={styles.weatherItem}>
              <MaterialCommunityIcons name="weather-windy" size={22}/>
              <Text style={styles.weatherLabel}>Wind</Text>
              <Text style={styles.weatherValue}>
                {recommendation.weather.windSpeed} m/s
              </Text>
            </View>
          ...
          <Text style={styles.climateText}>
            Climate Type: {recommendation.climate}
          </Text>
  ...
  <Text style={styles.aiItem}>
    🌱 Planting Suitability Score: {suitabilityScore}%
  </Text>

  <Text style={styles.aiItem}>
    🌧 Rainfall Prediction: {rainRisk}
  </Text>

  <Text style={styles.aiItem}>
    🌾 Climate Suitable Variety: {climateVariety}
  </Text>
</View>
            ...
            {loading ? (
              ...
              <>
                ...
                <Text style={styles.actionButtonText}>
                  {saved ? 'Report Ready' : 'Download Report'}
                </Text>
              </>
            )}
          </TouchableOpacity>
