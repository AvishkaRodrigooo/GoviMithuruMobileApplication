...
`,
            guideContent: {
                steps: [
                    { id: 1, title: 'Room Preparation', duration: 'Day 1', process: ['Empty the room completely', 'Sweep all corners thoroughly', 'Wipe walls/floor with phenyle solution', 'Check and seal cracks with cement/clay', 'Spread neem leaves in corners (natural repellent)', 'Place wooden boards/bricks for platform (15cm height)'], icon: 'home-edit-outline' },
